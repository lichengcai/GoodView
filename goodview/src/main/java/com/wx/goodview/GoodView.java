...
public class GoodView extends PopupWindow implements IGoodView {
    ...
    public void show(View v) {
        if (!isShowing()) {
            ...
            Log.d("show"," v.getHeight()---" + v.getHeight() + "   getHeight--" + getHeight());
            showAsDropDown(v, v.getWidth() / 2 - getWidth() / 2, offsetY);
            Log.d("show"," v.getWidth()---" + v.getWidth()/2 + "   getWidth--" + getWidth()/2);
    ...
    public void showRight(View v) {
        if (!isShowing()) {
            ...
            Log.d("show"," v.getHeight()---" + v.getMeasuredHeight() + "   getHeight--" + getHeight());
